        ...
        <main className="p-8 text-black/80">
            <div className="max-w-md mx-auto">
                <fieldset id="sign_up" className="border-transparent p-0 m-0">
                    <legend className="text-xl font-semibold p-0 m-0">Register</legend>
                    <div className="mt-4">
                        <label className="block font-semibold leading-relaxed text-sm" htmlFor="name">Name</label>
                        <input className="p-2 bg-transparent border border-black w-full hover:bg-black hover:text-white transition-colors outline-none" type="text" name="name" id="name" />
                    </div>
                    <div className="mt-4">
